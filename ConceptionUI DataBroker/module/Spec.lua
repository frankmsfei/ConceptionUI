...
function Spec.OnTooltipShow(tip)
	...
	tip:AddLine(' ')
	tip:AddDoubleLine('Toggle Talent Frame', '[L]', .38, .38, .38, .62, .38, 0)
	tip:AddDoubleLine('Swap Specialization', '[R]', .38, .38, .38, 0, .38, .62)
end
